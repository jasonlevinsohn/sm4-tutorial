				...
				?>
					<script type="text/javascript">
						...
						<?php if(isset($_SESSION['SESS_MEMBER_ID']) && isset($_SESSION['SESS_FIRST_NAME'])) { ?>
							var archiveButton<?php echo $siteRow[0]?> = Ext.get('archive<?php echo $siteRow[0]?>');
							var deleteButton<?php echo $siteRow[0]?> = Ext.get('delete<?php echo $siteRow[0]?>');
							
							archiveButton<?php echo $siteRow[0]?>.on('mouseover', function() {
								archiveButton<?php echo $siteRow[0]?>.highlight();
							});
							
							deleteButton<?php echo $siteRow[0]?>.on('mouseover', function() {
								deleteButton<?php echo $siteRow[0]?>.highlight();
							});
							
							archiveButton<?php echo $siteRow[0]?>.on('click', function() {
								
								Ext.MessageBox.show({
									title	: 'Archive Site - <?php echo $siteRow[0]; ?>',
									msg		: 'So.. you want to archive <?php echo $siteRow[2]; ?>',
									buttons	: Ext.MessageBox.YESNO,
									fn		: function(btn) {
										if(btn == 'yes') {
											archiveButton<?php echo $siteRow[0]?>.load({
												url		: 'archiveSite.php?archiveSite=<?php echo $siteRow[0]?>',
												scripts	: true
											});
										} else {
							...
							deleteButton<?php echo $siteRow[0]?>.on('click', function() {
								Ext.MessageBox.alert('Site <?php echo $siteRow[2]?>', 'Are you sure you want to delete site <?php echo $siteRow[1] ?>');
							});
					<? } /* END SESSION CHECK */ ?>	
						});
					...
					<th id="<?php echo 'site' . $siteRow[0] ?>" class="siteTitle"><?php echo $siteRow[2] . ' - ' . $siteRow[1];?>
						<div id="siteButtons">
						<?php if(isset($_SESSION['SESS_MEMBER_ID']) && isset($_SESSION['SESS_FIRST_NAME'])) { ?>
							<div id="<?php echo 'archive' . $siteRow[0] ?>" class="archiveButton">Archive</div>
							<div id="<?php echo 'delete' . $siteRow[0] ?>" class="deleteButton">Delete</div>
						<? } /* END SESSION CHECK */ ?>
						</div>
					</th>
				<?php } ?>	
